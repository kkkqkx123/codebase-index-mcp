...
export class ArithmeticLogicalRule implements SnippetExtractionRule {
  name = 'ArithmeticLogicalRule';
  supportedNodeTypes = new Set(['binary_expression', 'unary_expression', 'logical_expression', 'comparison_expression']);
