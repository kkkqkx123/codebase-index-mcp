...
export class FunctionCallChainRule implements SnippetExtractionRule {
  name = 'FunctionCallChainRule';
  supportedNodeTypes = new Set(['call_expression', 'expression_statement']);
