...
export class ObjectArrayLiteralRule implements SnippetExtractionRule {
  name = 'ObjectArrayLiteralRule';
  supportedNodeTypes = new Set(['object', 'array', 'object_pattern', 'array_pattern']);
