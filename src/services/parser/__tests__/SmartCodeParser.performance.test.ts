...
describe('SmartCodeParser Performance Tests', () => {
  ...
  describe('Performance benchmarks', () => {
    ...
    test('should handle concurrent processing efficiently', async () => {
      ...
      console.log(`Concurrent processing (10 files): ${totalTime.toFixed(2)}ms total, ${averageTime.toFixed(2)}ms average`);
  ...
  test('should recover gracefully from parsing errors', async () => {
    ...
    console.log(`Error recovery time: ${processingTime.toFixed(2)}ms, ${parsedFile.chunks.length} chunks`);
